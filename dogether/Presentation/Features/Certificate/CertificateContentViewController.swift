...
final class CertificateContentViewController: BaseViewController {
    ...
    override func setViewDatas() {
        ...
        bind(output.certificateViewDatas, update: certificateContentPage.updateCertificate)
        bind(output.certificateTextViewDatas, update: certificateContentPage.updateTextView)
        bind(output.certificateButtonViewDatas, update: certificateContentPage.updateCertifyButton)
    }
}
